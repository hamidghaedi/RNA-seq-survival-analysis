...
For publishing here I decided to add more details and steps in a way that helps everybody who need to get to know basics and codes needed for cancer survival analysis on RNA-seq data.
...
General formoula for calculating z-score is as z = [(value gene X in tumor Y)-(mean gene X in normal)]/(standard deviation X in normal).
